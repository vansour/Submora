...
#[component]
pub fn AppShell(title: String, summary: String, compact: bool, children: Element) -> Element {
    ...
    rsx! {
        div { class: "{page_class}",
            ...
            div { class: "{shell_class}",
                if compact {
                    header { class: "masthead masthead--compact panel panel--hero",
                        div { class: "masthead-copy masthead-copy--compact",
